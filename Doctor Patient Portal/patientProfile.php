<?php
	...
	if(!isset($_SESSION["loggedPatient"])){
		header("Location: login.php");
	}
	$username=$_SESSION["loggedPatient"];
...
td {
  height: 40px;
	...
	<h2 class="head2" align="middle">Patient Information</h2>
	<table border="1" align="center">
        <?php 
		$rs=getPatientByUsername($username);
                    foreach ($rs as $row){
		...
		<div align="middle"><a class="app1" href="patientEdit.php">Edit</a><div>
    </body>
</html>